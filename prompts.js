...
const PROMPTS = {
   ...
   */
  fetchSubsidies: () => `
あなたは島根県益田市の補助金・助成金制度に精通した専門家です。
2026年現在、島根県益田市の市民・事業者が申請可能または近日中に申請受付が予定されている補助金・助成金・支援制度を25件リストアップしてください。

以下を優先的に含めてください：
1. 益田市独自の補助金・助成金
2. 島根県の補助金（益田市民・益田市内事業者が対象のもの）
3. 国の補助金（益田市民・益田市内事業者も対象のもの：ものづくり補助金、IT導入補助金等）

以下のカテゴリから各3〜5件を目安に選んでください：
- 農業・林業・水産業
- 中小企業・創業支援
- 移住・定住支援
- 子育て・教育
  ...
  "subsidies": [
    {
      ...
      "issuer": "益田市",
      "region": "益田市",
      "applicationUrl": "https://www.city.masuda.lg.jp/",
...
- issuer: "益田市" / "島根県" / "国" など発行元
- region: "益田市" または "島根県全域"（国の補助金の場合）
- applicationUrl: 公式ページURL（不明の場合は益田市公式サイト https://www.city.masuda.lg.jp/）
...
`,
  ...
  reverseSearch: (intent, existingSubsidies = []) => {
    ...
    return `
あなたは島根県益田市の補助金・助成金のアドバイザーです。
ユーザーの状況・やりたいことに最も適した補助金・助成金を益田市内・島根県・国の制度から提案してください。
...
上記の状況に合った益田市・島根県・国の補助金・助成金を5件以内で提案してください。
既存リストにないものも含めて構いません。
